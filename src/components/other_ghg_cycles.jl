    ...
    function run_timestep(p, v, d, t)
        ...
        for g in d.other_ghg
            ...
            if is_first(t)
               ...
               v.conc_other_ghg[t,g] = v.conc_other_ghg[t-1,g] - v.conc_other_ghg[t-1,g] * (1.0 - exp(-1/p.other_ghg_τ[g])) + 0.5 * (p.emiss_other_ghg[t-1,g] + p.emiss_other_ghg[t,g]) * (1.0/p.emiss2conc_other_ghg[g])
            end
        end

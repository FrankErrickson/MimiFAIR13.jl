...
@defcomp n2o_cycle begin
    ...
    N₂O_fossil_emissions  = Parameter(index=[time]) # Fossil-fuel nitrous oxide emissions (Mt N₂ yr⁻¹).
    N₂O_natural_emissions = Parameter(index=[time]) # Natural nitrous oxide emissions (Mt N₂ yr⁻¹).
    ...
    function run_timestep(p, v, d, t)
        ...
        if is_first(t)
            ...
            emiss_prev = p.N₂O_fossil_emissions[t-1] + p.N₂O_natural_emissions[t]
            emiss_curr = p.N₂O_fossil_emissions[t] + p.N₂O_natural_emissions[t]

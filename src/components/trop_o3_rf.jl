...
@defcomp trop_o3_rf begin
    ...
    fix_pre1850_RCP_o3    = Parameter{Bool}()       # Switch to use different relationship for 1750/65 to 1850 based on anthropogenic emissions from Skeie et al. (2011) (atmos-chem-phys.net/11/11827/2011).
    ...
    function run_timestep(p, v, d, t)
        ...
        if gettime(t) >= 1850 || p.fix_pre1850_RCP_o3 == false
